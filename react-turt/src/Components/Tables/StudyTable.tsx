    ...
    <table className="table-list" >
      <thead className='thead'>
        <tr className="bg-gray-100 hover:bg-gray-50" >
          ...
          <th className="table-text">{qualificationSeeking}</th>
          <th className="table-text">{scholarship}</th>
          <th className="table-text">{programType}</th>
      ...
      <tbody className="hover:bg-gray-50">
        ...
        <tr className="hover:bg-gray-50" onClick={handleRowClick}>
            ...
            <td className="border-b">{state.qualificationSeeking}</td>
            <td className="border-b">{state.scholarship}</td>
            <td className="border-b">{state.programType}</td>
